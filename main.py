...
bot = Client("bot",
             bot_token= "7028934129:AAH_vfn0QE-BHsbqBAbrXtlNcd7GKNaVsy8",
             api_id= 26209173,
...
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text(f"Hello Mere Malik Rock Bhai Hai [{m.from_user.first_name}](tg://user?id={m.from_user.id})\nPress /ROCK")
